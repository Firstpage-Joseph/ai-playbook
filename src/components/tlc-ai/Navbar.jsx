      ...
      >
        ...
        {!isMobile && (
          <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
            ...
            <Btn href="#audit" variant="red" style={{ padding: '9px 20px', fontSize: 13 }}>Free AI Audit</Btn>
          </div>
        )}

        {isMobile && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <Btn href="#audit" variant="red" style={{ padding: '8px 16px', fontSize: 13 }}>Audit</Btn>
            <button
